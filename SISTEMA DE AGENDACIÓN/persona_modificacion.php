...
<form id="formModificarPersona" action="persona_modificacion2.php" method="POST">
...
<script>
document.getElementById("formModificarPersona").addEventListener("submit", function(e){
