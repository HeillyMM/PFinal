...
<body>
    <div class="form-container">
        <form action="chofer_adicion2.php" method="post" onsubmit="return validateChoferForm(this)">
            <h2> Adicionar CHOFER</h2>
    ...
    <script>
        function validateChoferForm(form) {
            ...
            return confirm('¿Confirma que desea adicionar a este chofer?');
        }
    </script>
</body>
</html>