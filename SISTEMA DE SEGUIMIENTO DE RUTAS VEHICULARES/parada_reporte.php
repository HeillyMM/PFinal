...
<head>
    ...
    <title>Reporte de Paradas</title>
...
<body>
    <div class="report-container">
        <h1>📍 Reporte de Paradas</h1>

        <?php
        $ls = mysqli_query($conexion, "SELECT idparada, puntoparada, descripcion FROM parada");
        if (!$ls) {
        ...
        <?php elseif ($count == 0): ?>
            <div class="empty-message">
                Aún no hay paradas registradas en el sistema.
            </div>
        <?php endif; ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (table) {
                ...
                if (rowCount > 0) {
                    title.innerHTML += ` (${rowCount} Paradas)`;
                }
            }
        });
    </script>
